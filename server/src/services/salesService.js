  ...
  const transaction =
    db.transaction(() => {
      ...
      for (
         ...
         * SALES COGS
         *
         * Remove inventory using current
        ...
        /*
         * Stock transaction stores the
         * actual COGS unit cost.
         */
        addStockTransaction({
          transactionDate:
            data.invoiceDate,
...
export function getSalesInvoiceById(
  id
) {
  const invoice =
    db.prepare(`
  ...
  const transaction =
    db.transaction(() => {
      ...
      for (
        ...
        /*
         * Find the COGS unit cost that
         * was used when the sale was made.
         */
        const saleCost =
          db.prepare(`
            SELECT
