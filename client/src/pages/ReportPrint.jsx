  ...
  return (
    <div className="report-print-page">
      <style>{`
        ...
        .summary-box { border: 1px solid #e2d5cb; border-radius: 5px; padding: 9px; }
        ...
        .report-footer { margin-top: 14px; padding-top: 8px; border-top: 1px solid #e7dcd2; font-size: 9px; color: #80756e; display: flex; justify-content: space-between; }
